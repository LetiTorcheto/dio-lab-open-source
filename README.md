...
2. Clona localmente: `git clone https://github.com/LetiTorcheto/dio-lab-open-source.git`;
...
8. Crea un commit y añade un mensaje indicando la adición de tu perfil `git commit -m"feat: add LetiTorcheto profile"`;
